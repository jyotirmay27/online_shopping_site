...
<div class="column zoom">
  <img src="assets/upar.jpg"  width="250" height="150" >
  <div class="container">
  <p style="font-size:25px;font-family:fantasy  ;color: orange;">Top Wear</p>
  </div>
</div>
</a>
<a href="bottom.php">
<div class="column zoom">
  <img src="assets/trousers.jpg"  width="250" height="150" >
  <div class="container">
  <p style="font-size:25px;font-family:fantasy  ;color: purple;">Bottom Wear</s></p>
  </div>
</div>
</a>
<a href="shoes.php">
<div class="column zoom">
  <img src="assets/shoes.jpg"  width="250" height="150" >
  <div class="container">
  <p style="font-size:25px;font-family:fantasy  ;color: skyblue;">Shoes</s></p>
  </div>
</div>
</a>
<a href="hats.php">
<div class="column zoom">
    <img src="assets/hat.jpg"  width="250" height="150">
    <div class="container">
    <p style="font-size:25px;font-family:fantasy  ;color: pink;">Hats</s></p>
    </div>
  </div>
  </a>
  <a href="watch.php">
  <div class="column zoom">
    <img src="assets/watch.jpg"  width="250" height="150">
    <div class="container">
    <p style="font-size:25px;font-family:fantasy  ;color: magenta;">Watches</s></p>
    </div>
  </div>
</a>
</div>
...
<a href="Titem1.php">
    ...
    <a href="sitem2.php">
    <div class="column zoom">
      <img src="assets/shoes2.jpg" alt="Norther Lights" width="424" height="210">
      <div class="container">
    ...
    <a href="witem3.php">
    <div class="column zoom">
        <img src="assets/watch1.jpg" alt="Norther Lights" width="424" height="210">
        <div class="container">
    ...
    <div class="row">
      <a href="witem.php">
        <div class="column zoom">
          <img src="assets/watch2.jpg" alt="5 Terre" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="Hitem1.php">
        <div class="column zoom">
          <img src="assets/hat1.jpg" alt="Norther Lights" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3500(40% OFF)</s></p>
          </div>
        </div>
        </a>
        <a href="sitem1.php">
        <div class="column zoom">
            <img src="assets/shoes1.jpg" alt="Norther Lights" width="424" height="210">
            <div class="container">
            <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3500(40% OFF) </s></p>
            </div>
          </div>
        ...
        <a href="Hitem2.php">
        <div class="column zoom">
          <img src="assets/hat2.jpg" alt="5 Terre" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
