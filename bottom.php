...
<a href="bitem.php">
    <div class="column zoom">
      <img src="assets/trouser1.jpeg"  width="424" height="210">
      <div class="container">
      <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3499(40% OFF</p>
      </div>
    </div>
    </a>
    ...
    <a href="bitem1.php">
    <div class="column zoom">
      <img src="assets/trouser2.jpg" alt="Norther Lights" width="424" height="210">
      <div class="container">
    ...
    <a href="bitem2.php">
    <div class="column zoom">
        <img src="assets/trouser3.jpg" alt="Norther Lights" width="424" height="210">
        <div class="container">
        <p style="font-family:Brush Script MT  ;color: blue;">₹1500 <s style="color: red;">₹3750(60% OFF)</p>
        </div>
      </div>
      </a>
    </div>
    ...
    <div class="row">
      <a href="bitem.php">
        <div class="column zoom">
          <img src="assets/trouser4.jpg" alt="5 Terre" width="424" height="210" >
          <div class="container">
        ...
        <a href="bitem1.php">
        <div class="column zoom">
          <img src="assets/trouser5.jpg" alt="Norther Lights" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="bitem2.php">
        <div class="column zoom">
            <img src="assets/trouser6.jpg" alt="Norther Lights" width="424" height="210">
            <div class="container">
