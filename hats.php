...
<a href="Hitem1.php">
    <div class="column zoom">
      <img src="assets/hat1.jpg"  width="424" height="210">
      <div class="container">
    ...
    <a href="Hitem2.php">
    <div class="column zoom">
      <img src="assets/hat2.jpg"  width="424" height="210">
      <div class="container">
    ...
    <a href="Hitem3.php">
    <div class="column zoom">
        <img src="assets/hat3.jpg"  width="424" height="210">
        <div class="container">
    ...
    <div class="row">
      <a href="Hitem1.php">
        <div class="column zoom">
          <img src="assets/hat4.jpg" " width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3499(40% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="Hitem2.php">
        <div class="column zoom">
          <img src="assets/hat5.jpg"  width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="Hitem3.php">
        <div class="column zoom">
            <img src="assets/hat6.jpg"  width="424" height="210">
            <div class="container">
            <p style="font-family:Brush Script MT  ;color: blue;">₹1500 <s style="color: red;">₹3750(60% OFF)</s></p>
            </div>
          </div>
