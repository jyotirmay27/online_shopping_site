...
<a href="sitem1.php">
    <div class="column zoom">
      <img src="assets/shoes1.jpg"  width="424" height="210">
      <div class="container">
    ...
    <a href="sitem3.php">
    <div class="column zoom">
        <img src="assets/shoes3.jpg" alt="Norther Lights" width="424" height="210">
        <div class="container">
    ...
    <div class="row">
      <a href="sitem1.php">
        <div class="column zoom">
          <img src="assets/shoes.jpg" alt="5 Terre" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3499(40% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="sitem2.php">
        <div class="column zoom">
          <img src="assets/shoes5.jpg" alt="Norther Lights" width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="sitem3.php">
        <div class="column zoom">
            <img src="assets/shoes6.jpg" alt="Norther Lights" width="424" height="210">
            <div class="container">
            <p style="font-family:Brush Script MT  ;color: blue;">₹1500 <s style="color: red;">₹3750(60% OFF)</s></p>
            </div>
          </div>
