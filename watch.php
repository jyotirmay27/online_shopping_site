...
<a href="witem1.php">
    <div class="column zoom">
      <img src="assets/watch1.jpg"  width="424" height="210">
      <div class="container">
    ...
    <a href="witem.php">
    <div class="column zoom">
      <img src="assets/watch2.jpg"  width="424" height="210">
      <div class="container">
    ...
    <a href="witem3.php">
    <div class="column zoom">
        <img src="assets/watch3.jpg"  width="424" height="210">
        <div class="container">
    ...
    <div class="row">
      <a href="witem1.php">
        <div class="column zoom">
          <img src="assets/watch4.jpg"  width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2099 <s style="color: red;">₹3499(40% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="witem.php">
        <div class="column zoom">
          <img src="assets/watch5.jpg"  width="424" height="210" >
          <div class="container">
          <p style="font-family:Brush Script MT  ;color: blue;">₹2000 <s style="color: red;">₹4000(50% OFF)</s></p>
          </div>
        </div>
        ...
        <a href="witem3.php">
        <div class="column zoom">
            <img src="assets/watch6.jpg"  width="424" height="210">
            <div class="container">
            <p style="font-family:Brush Script MT  ;color: blue;">₹1500 <s style="color: red;">₹3750(60% OFF)</s></p>
            </div>
          </div>
